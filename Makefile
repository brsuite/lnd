PKG := github.com/brsuite/lnd
ESCPKG := github.com\/brsuite\/lnd
...
build-itest:
	@$(call print, "Building itest brond and lnd.")
...
build-itest-race:
	@$(call print, "Building itest brond and lnd with race detector.")
	CGO_ENABLED=0 $(GOBUILD) -tags="rpctest" -o lntest/itest/brond-itest$(EXEC_SUFFIX) $(ITEST_LDFLAGS) $(BROND_PKG)
