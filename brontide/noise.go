...
var (
	...
	ephemeralGen = func() (*bronec.PrivateKey, error) {
...
func ecdh(pub *bronec.PublicKey, priv keychain.SingleKeyECDH) ([]byte, error) {
...
type handshakeState struct {
	...
	remoteStatic    *bronec.PublicKey
	remoteEphemeral *bronec.PublicKey
}
...
func newHandshakeState(initiator bool, prologue []byte,
	...
	remotePub *bronec.PublicKey) handshakeState {
...
func EphemeralGenerator(gen func() (*bronec.PrivateKey, error)) func(*Machine) {
...
func NewBrontideMachine(initiator bool, localKey keychain.SingleKeyECDH,
	remotePub *bronec.PublicKey, options ...func(*Machine)) *Machine {
...
func (b *Machine) RecvActOne(actOne [ActOneSize]byte) error {
	...
	// e
	b.remoteEphemeral, err = bronec.ParsePubKey(e[:], bronec.S256())
	if err != nil {
		return err
	}
...
func (b *Machine) RecvActThree(actThree [ActThreeSize]byte) error {
	...
	b.remoteStatic, err = bronec.ParsePubKey(remotePub, bronec.S256())
	if err != nil {
		return err
	}
