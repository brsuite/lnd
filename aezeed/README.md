...
[In this PR](https://github.com/brsuite/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/brsuite/lnd/aezeed
...
PASS
ok      github.com/brsuite/lnd/aezeed  4.168s
```
