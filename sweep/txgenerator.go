...
func createSweepTx(inputs []input.Input, outputs []*wire.TxOut,
	...
	for _, o := range inputs {
		...
		totalInput += bronutil.Amount(o.SignDesc().Output.Value)
		requiredOutput += bronutil.Amount(o.RequiredTxOut().Value)
	}
	...
	for _, o := range outputs {
		sweepTx.AddTxOut(o)
		requiredOutput += bronutil.Amount(o.Value)
	}
