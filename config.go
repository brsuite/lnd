...
var (
	...
	DefaultLndDir = bronutil.AppDataDir("lnd", false)
	...
	defaultLtcdDir         = bronutil.AppDataDir("ltcd", false)
	defaultLtcdRPCCertFile = filepath.Join(defaultLtcdDir, "rpc.cert")

	defaultBrocoindDir  = bronutil.AppDataDir("brocoin", false)
	defaultLitecoindDir = bronutil.AppDataDir("litecoin", false)
...
// This function is taken from https://github.com/brsuite/brond
