...
type Config struct {
	...
	// contract breach.
	RequiredRemoteDelay func(bronutil.Amount) uint16
	...
	// offer us.
	RequiredRemoteMaxHTLCs func(bronutil.Amount) uint16
...
func (f *Manager) handleFundingOpen(peer lnpeer.Peer,
	...
	if amt < f.cfg.MinChanSize {
		f.failFundingFlow(
			peer, msg.PendingChannelID,
			lnwallet.ErrChanTooSmall(amt, bronutil.Amount(f.cfg.MinChanSize)),
		)
		return
	}
