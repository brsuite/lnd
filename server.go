...
import (
	...
	"github.com/brsuite/lnd/brontide"
	"github.com/brsuite/lnd/cert"
	...
	"github.com/brsuite/lnd/subscribe"
	"github.com/brsuite/lnd/sweep"
	"github.com/brsuite/lnd/ticker"
	"github.com/brsuite/lnd/tor"
	"github.com/brsuite/lnd/walletunlocker"
	"github.com/brsuite/lnd/watchtower/blob"
	"github.com/brsuite/lnd/watchtower/wtclient"
	"github.com/brsuite/lnd/watchtower/wtpolicy"
	"github.com/brsuite/lnd/watchtower/wtserver"
)
...
func newServer(cfg *Config, listenAddrs []net.Addr,
	...
	s.fundingMgr, err = funding.NewFundingManager(funding.Config{
		...
		RequiredRemoteDelay: func(chanAmt bronutil.Amount) uint16 {
			...
			delay := uint16(bronutil.Amount(maxRemoteDelay) *
		...
		RequiredRemoteChanReserve: func(chanAmt,
			dustLimit bronutil.Amount) bronutil.Amount {
		...
		MinChanSize:                   bronutil.Amount(cfg.MinChanSize),
		MaxChanSize:                   bronutil.Amount(cfg.MaxChanSize),
