...
import (
	...
	"github.com/brsuite/lnd/macaroons"
	"github.com/brsuite/lnd/peer"
	"github.com/brsuite/lnd/peernotifier"
	"github.com/brsuite/lnd/record"
	"github.com/brsuite/lnd/routing"
	"github.com/brsuite/lnd/routing/route"
...
func (r *rpcServer) addDeps(s *server, macService *macaroons.Service,
	...
	routerBackend := &routerrpc.RouterBackend{
		...
		FetchChannelCapacity: func(chanID uint64) (bronutil.Amount,
			error) {
...
func addrPairsToOutputs(addrPairs map[string]int64,
	...
	for addr, amt := range addrPairs {
		addr, err := bronutil.DecodeAddress(addr, params)
		if err != nil {
			return nil, err
		}
...
func (r *rpcServer) SendCoins(ctx context.Context,
	...
	if in.SendAll {
		...
		var reservedVal bronutil.Amount
		err = wallet.WithCoinSelectLock(func() error {
			var err error
...
func newFundingShimAssembler(chanPointShim *lnrpc.ChanPointShim, initiator bool,
	...
	return chanfunding.NewCannedAssembler(
		...
		bronutil.Amount(chanPointShim.Amt), &localKeyDesc,
		remoteKey, initiator,
	), nil
}
...
func newPsbtAssembler(req *lnrpc.OpenChannelRequest, normalizedMinConfs int32,
	...
	return chanfunding.NewPsbtAssembler(
		bronutil.Amount(req.LocalFundingAmount), packet, netParams,
		!psbtShim.NoPublish,
	), nil
}
...
func (r *rpcServer) CloseChannel(in *lnrpc.CloseChannelRequest,
	...
	if force {
		...
		if len(in.DeliveryAddress) > 0 {
			...
			addr, err := bronutil.DecodeAddress(
...
func (r *rpcServer) WalletBalance(ctx context.Context,
	...
	var totalBalance, confirmedBalance, unconfirmedBalance bronutil.Amount
...
func (r *rpcServer) fetchPendingOpenChannels() (pendingOpenChannels, error) {
	...
	for i, pendingChan := range channels {
		...
		utx := bronutil.NewTx(localCommitment.CommitTx)
...
func createRPCOpenChannel(r *rpcServer, graph *channeldb.ChannelGraph,
	...
	utx := bronutil.NewTx(localCommit.CommitTx)
	commitBaseWeight := blockchain.GetTransactionWeight(utx)
	commitWeight := commitBaseWeight + input.WitnessCommitmentTxWeight
	...
	var sumOutputs bronutil.Amount
	for _, txOut := range localCommit.CommitTx.TxOut {
		sumOutputs += bronutil.Amount(txOut.Value)
	}
...
func (r *rpcServer) GetNetworkInfo(ctx context.Context,
	...
	var (
		...
		numChannels          uint32
		maxChanOut           uint32
		totalNetworkCapacity bronutil.Amount
		minChannelSize       bronutil.Amount = math.MaxInt64
		maxChannelSize       bronutil.Amount
		medianChanSize       bronutil.Amount
	)
...
func (r *rpcServer) FundingStateStep(ctx context.Context,
	...
	case in.GetShimRegister() != nil &&
		...
		req := &chanfunding.Request{
			RemoteAmt: bronutil.Amount(rpcShimIntent.Amt),
		}
