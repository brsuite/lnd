...
[`cipher seed`](https://github.com/brsuite/lnd/tree/master/aezeed).
...
[INF] CHBU: Updating backup file at test_lnd3/data/chain/brocoin/simnet/channel.backup
[INF] CHBU: Swapping old multi backup file from test_lnd3/data/chain/brocoin/simnet/temp-dont-use.backup to test_lnd3/data/chain/brocoin/simnet/channel.backup
...
`~/.lnd/data/chain/brocoin/mainnet/channel.backup`
...
Once the process has been initiated, `lnd` will proceed to:
  ...
  2. Once the channel shell is recovered, the
     [chanbackup](https://github.com/brsuite/lnd/tree/master/chanbackup)
