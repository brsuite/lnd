...
initial [Lightning Network Specifications](https://github.com/brsuite/lightning-rfc).
...
- Changes to publicly exported packages such as
  [brontide](https://github.com/brsuite/lnd/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/brsuite/lnd/blob/master/lntest/harness.go)
  contained within `lnd`. For example integration tests, see
  [`lnd_test.go`](https://github.com/brsuite/lnd/blob/master/lnd_test.go#L181). 
...
[perusing the make file documentation](https://github.com/brsuite/lnd/blob/master/docs/MAKEFILE.md).
...
definitions, check out the [lnrpc README](https://github.com/brsuite/lnd/blob/master/lnrpc/README.md).
...
of `lnd` such as `brond`, `neutrino`, `bronwallet`, etc. In order to test changes
...
```shell
⛰  go mod edit -replace=github.com/brsuite/lightning-onion@v0.0.0-20180605012408-ac4d9da8f1d6=github.com/roasbeef/lightning-onion@2e5ae87696046298365ab43bcd1cf3a7a1d69695
```
...
PR](https://github.com/brsuite/lnd/tree/master/docs/release-notes).
...
Rejoice as you will now be listed as a [contributor](https://github.com/brsuite/lnd/graphs/contributors)!
...
[MIT license](https://github.com/brsuite/lnd/blob/master/LICENSE).  This is
