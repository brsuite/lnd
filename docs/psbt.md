...
Brocoin Transactions (PSBTs). `lnd`'s wallet now features a full set of PSBT
...
const adminMac = fs.readFileSync(`${LND_DIR}/data/chain/brocoin/${NETWORK}/admin.macaroon`);
