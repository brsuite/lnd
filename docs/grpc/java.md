...
Note the ***proto*** folder, where all the proto files are kept.
 ...
 - [lightning.proto](https://github.com/brsuite/lnd/blob/master/lnrpc/lightning.proto)
...
public class Main {
  ...
  private static final String MACAROON_PATH = "/Users/user/Library/Application Support/Lnd/data/chain/brocoin/simnet/admin.macaroon";
