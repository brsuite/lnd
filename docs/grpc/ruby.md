...
```shell
⛰  curl -o lightning.proto -s https://raw.githubusercontent.com/brsuite/lnd/master/lnrpc/lightning.proto
```
...
macaroon_binary = File.read(File.expand_path("~/.lnd/data/chain/brocoin/simnet/admin.macaroon"))
