...
5. Copy the lnd lightning.proto file (you'll find this at
  [lnrpc/lightning.proto](https://github.com/brsuite/lnd/blob/master/lnrpc/lightning.proto))
  or just download it
    ```shell
    lnd ⛰  curl -o lightning.proto -s https://raw.githubusercontent.com/brsuite/lnd/master/lnrpc/lightning.proto
    ```
...
```shell
lnd ⛰  curl -o router.proto -s https://raw.githubusercontent.com/brsuite/lnd/master/lnrpc/routerrpc/router.proto
...
# Lnd admin macaroon is at ~/.lnd/data/chain/brocoin/simnet/admin.macaroon on Linux and
# ~/Library/Application Support/Lnd/data/chain/brocoin/simnet/admin.macaroon on Mac
with open(os.path.expanduser('~/.lnd/data/chain/brocoin/simnet/admin.macaroon'), 'rb') as f:
