...
```shell
⛰  mkdir Grpc
⛰  curl -o Grpc/lightning.proto -s https://raw.githubusercontent.com/brsuite/lnd/master/lnrpc/lightning.proto
```
...
```cs
// Lnd admin macaroon is at <LND_DIR>/data/chain/brocoin/simnet/admin.macaroon on Windows
// ~/.lnd/data/chain/brocoin/simnet/admin.macaroon on Linux and ~/Library/Application Support/Lnd/data/chain/brocoin/simnet/admin.macaroon on Mac
byte[] macaroonBytes = File.ReadAllBytes("<LND_DIR>/data/chain/brocoin/simnet/admin.macaroon");
