...
import (
	...
	"github.com/brsuite/lnd/amp"
	"github.com/brsuite/lnd/batch"
	...
	"github.com/brsuite/lnd/multimutex"
	"github.com/brsuite/lnd/record"
	"github.com/brsuite/lnd/routing/chainview"
	"github.com/brsuite/lnd/routing/route"
	"github.com/brsuite/lnd/routing/shards"
...
func (r *ChannelRouter) networkHandler() {
	...
	//
	// See https://github.com/brsuite/lnd/issues/4892.
...
func (r *ChannelRouter) processUpdate(msg interface{},
	...
	case *channeldb.ChannelEdgeInfo:
		...
		msg.Capacity = bronutil.Amount(chanUtxo.Value)
