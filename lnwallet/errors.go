...
func ErrChanReserveTooSmall(reserve, dustLimit bronutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanReserveTooLarge(reserve,
	maxReserve bronutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooSmall(chanSize, minChanSize bronutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooLarge(chanSize, maxChanSize bronutil.Amount) ReservationError {
	return ReservationError{
...
// was rejected.
func ErrInvalidDustLimit(dustLimit bronutil.Amount) ReservationError {
	return ReservationError{
