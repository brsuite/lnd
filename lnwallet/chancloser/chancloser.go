...
type ChanCloser struct {
	...
	lastFeeProposal bronutil.Amount
	...
	priorFeeOffers map[bronutil.Amount]*lnwire.ClosingSigned
...
func NewChanCloser(cfg ChanCloseCfg, deliveryScript []byte,
	...
	return &ChanCloser{
		...
		priorFeeOffers:      make(map[bronutil.Amount]*lnwire.ClosingSigned),
...
// compromise fee.
func (c *ChanCloser) proposeCloseSigned(fee bronutil.Amount) (*lnwire.ClosingSigned, error) {
...
func feeInAcceptableRange(localFee, remoteFee bronutil.Amount) bool {
...
// our offered fee.
func ratchetFee(fee bronutil.Amount, up bool) bronutil.Amount {
...
func calcCompromiseFee(chanPoint wire.OutPoint, ourIdealFee, lastSentFee,
	remoteFee bronutil.Amount) bronutil.Amount {
