...
func (b *bronwallet) FetchInputInfo(prevOut *wire.OutPoint) (*lnwallet.Utxo, error) {
	...
	return &lnwallet.Utxo{
		...
		Value:         bronutil.Amount(txOut.Value),
...
func (b *bronwallet) fetchPrivKey(
	...
	hash160 := bronutil.Hash160(keyDesc.PubKey.SerializeCompressed())
	addr, err := bronutil.NewAddressWitnessPubKeyHash(hash160, b.netParams)
	if err != nil {
		return nil, err
	}
