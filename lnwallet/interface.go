...
type TransactionDetail struct {
	...
	DestAddresses []bronutil.Address
...
type WalletController interface {
	...
	ConfirmedBalance(confs int32, accountFilter string) (bronutil.Amount,
		error)
	...
	NewAddress(addrType AddressType, change bool,
		account string) (bronutil.Address, error)
	...
	IsOurAddress(a bronutil.Address) bool
