...
func Decode(invoice string, net *chaincfg.Params) (*Invoice, error) {
	...
	// https://github.com/brsuite/lightning-rfc/pull/844 for more
	// information.
...
func parseFallbackAddr(data []byte, net *chaincfg.Params) (bronutil.Address, error) { // nolint:dupl
	...
	case 0:
		...
		switch len(witness) {
		case 20:
			addr, err = bronutil.NewAddressWitnessPubKeyHash(witness, net)
		case 32:
			addr, err = bronutil.NewAddressWitnessScriptHash(witness, net)
		default:
	...
	case 17:
		...
		addr, err = bronutil.NewAddressPubKeyHash(pubKeyHash, net)
		if err != nil {
			return nil, err
		}
	case 18:
		...
		addr, err = bronutil.NewAddressScriptHashFromHash(scriptHash, net)
		if err != nil {
			return nil, err
		}
	default:
