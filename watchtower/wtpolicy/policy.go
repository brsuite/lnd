...
// policy's fee rate.
func (p *Policy) ComputeAltruistOutput(totalAmt bronutil.Amount,
	txWeight int64) (bronutil.Amount, error) {
...
func (p *Policy) ComputeRewardOutputs(totalAmt bronutil.Amount,
	txWeight int64) (bronutil.Amount, bronutil.Amount, error) {
...
func (p *Policy) ComputeJusticeTxOuts(totalAmt bronutil.Amount, txWeight int64,
