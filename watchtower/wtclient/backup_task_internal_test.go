...
import (
	...
	"github.com/brsuite/lnd/watchtower/wtdb"
	"github.com/brsuite/lnd/watchtower/wtmock"
...
func genTaskTest(
	...
	return backupTaskTest{
		...
		expTotalAmt:      bronutil.Amount(toLocalAmt + toRemoteAmt),
