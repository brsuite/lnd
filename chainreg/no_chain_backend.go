...
func (n *NoChainSource) Rescan(*chainhash.Hash, []bronutil.Address,
	map[wire.OutPoint]bronutil.Address) error {

	return nil
}

func (n *NoChainSource) NotifyReceived([]bronutil.Address) error {
	return nil
}
