...
import (
	...
	"github.com/brsuite/lnd/lntest/channels"
...
func createTestChannel(alicePrivKey, bobPrivKey []byte,
	aliceAmount, bobAmount, aliceReserve, bobReserve bronutil.Amount,
...
func createClusterChannels(aliceToBob, bobToCarol bronutil.Amount) (
...
func createTwoClusterChannels(aliceToBob, bobToCarol bronutil.Amount) (
