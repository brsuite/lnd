...
// amount to test.
type dustClosure func(chainfee.SatPerKWeight, bool, bool, bronutil.Amount) bool

// dustHelper is used to construct the dustClosure.
func dustHelper(chantype channeldb.ChannelType, localDustLimit,
	remoteDustLimit bronutil.Amount) dustClosure {

	isDust := func(feerate chainfee.SatPerKWeight, incoming,
		localCommit bool, amt bronutil.Amount) bool {
