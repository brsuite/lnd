...
func (s *Switch) htlcForwarder() {
	...
	var (
		...
		totalSatSent    bronutil.Amount
		totalSatRecv    bronutil.Amount
	)
	...
	for {
		...
		case <-s.cfg.LogEventTicker.Ticks():
			...
			var (
				...
				newSatSent    bronutil.Amount
				newSatRecv    bronutil.Amount
			)
			...
			var (
				...
				diffSatSent    bronutil.Amount
				diffSatRecv    bronutil.Amount
			)
